...
urlpatterns = [
    ...
    path('api/book-community-reviews/', views.book_community_reviews, name='api-book-community-reviews'),
    path('api/book-shelves/', views.book_shelves, name='api-book-shelves'),
